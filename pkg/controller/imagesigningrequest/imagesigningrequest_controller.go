...
import (
	...
	imagesigningrequestsv1alpha1 "github.com/redhat-cop/image-scanning-signing-service/image-security/pkg/apis/imagesigningrequests/v1alpha1"
...
// Add creates a new ImageSigningRequest Controller and adds it to the Manager. The Manager will set fields on the Controller
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileImageSigningRequest{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to primary resource ImageSigningRequest
	...
	// Watch for changes to secondary resource Pods and requeue the owner ImageSigningRequest
...
func (r *ReconcileImageSigningRequest) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set ImageSigningRequest instance as the owner and controller
...
func newPodForCR(cr *imagesigningrequestsv1alpha1.ImageSigningRequest) *corev1.Pod {
